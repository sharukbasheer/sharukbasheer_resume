            ...
            <div className="order-2 lg:order-1 space-y-2 lg:space-y-3">
              ...
              <div className="space-y-1">
                <p className="text-base sm:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  I am a passionate and results-driven software developer with over 3 years of experience 
                  specializing in .NET technologies. My expertise spans across building robust Web APIs, 
                  dynamic desktop applications, and modern web interfaces.
                </p>
                <p className="text-sm sm:text-base lg:text-lg text-gray-500 dark:text-gray-400 leading-relaxed">
                  I have hands-on experience with frameworks like MAUI, Avalonia, WPF, and WinForms, 
                  enabling me to craft cross-platform solutions. I'm also proficient in React, JavaScript, 
                  and TypeScript for full-stack development.
                </p>
              </div>
              <div className="pt-3">
              ...
              <div className="lg:col-span-1">
                ...
                <div className="space-y-2">
                  ...
                  <button className="group w-full flex items-center gap-3 bg-[#D14836] hover:bg-[#b43728] text-white px-4 py-3 rounded-lg font-medium text-sm transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                    <svg className="w-4 h-4 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 512 512">
