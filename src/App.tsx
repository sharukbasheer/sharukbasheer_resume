  ...
  function App() {
    ...
    return (
      <div className="h-screen flex flex-col overflow-hidden">
          <nav className="bg-white border-gray-200 dark:bg-gray-900 flex-shrink-0">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              ...
              >
                <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  <li onClick={()=>{ console.log(location.pathname)}}>
                    <Link
                      className={location.pathname==="/" ? SwtichTabColor.blue : SwtichTabColor.gray }
                      to="/"
                    >
                      Home
                    </Link>
                  ...
                  <li onClick={()=>{ console.log(location.pathname)}}>
                    <Link
                      className={location.pathname==="/About" ? SwtichTabColor.blue : SwtichTabColor.gray}
                      to="/About"
                    >
                      About
                    </Link>
                  ...
                  <li onClick={()=>{ console.log(location.pathname)}}>
                    <Link
                      className={location.pathname==="/Contact" ? SwtichTabColor.blue : SwtichTabColor.gray}
                      to="/Contact"
                    >
                      Contact
                    </Link>
